...
int main()
{
	...
	do
	{
		...
		case 3:	//quit program
			break;
		default:
			cout << "Invalid choice! Please select a choice from the menu above.";
		}
...
int loadFile(string fileStuff[])
{
	...
	//use file
			//for loop to get size of array
	for (int i = 0; getline(inFile, fileContent); i++, count++)
	{
		fileStuff[i] = fileContent;
	}
	//CLOSE the file!!!
	inFile.close();
